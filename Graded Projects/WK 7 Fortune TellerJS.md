...
## Due: Monday Week Eight By 9:30 AM
### - [GitHub Submission Link](https://docs.google.com/forms/d/e/1FAIpQLScUEvl_ZgH_OgBu0zbg_WIvB6zBSkkXh7wfxqjv4LwLdBDxLg/viewform)

## Overview
As a Junior Developer you are being tasked with developing a ASP.Net Website application. When complete, the application will provide the customer with their fortune based on data received from the customer.
...
During application development process, the following User Web interface(UI) requirements where identified. 
...
- [ ] The application MUST ask the user to select a favorite color from the following colors: Red, Orange, Yellow, Green, Blue, Indigo, Violet.
	...
	- [ ] The 'Help' menu MUST be accessed by the user after selecting a 'Help' button or link.
- [ ] The application MUST ask for the users number of siblings.
	
### Application Logic Requirements

During application development process,the following Application Logic requirements where identified. These requirements MUST be met using JavaScript.
